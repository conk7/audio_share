...
class App:
    def __init__(self, ip: str, port: int) -> None:
        ...
        self.ConnectionManager: ConnectionManager = get_connection_manager(
            ip, port, self.Player
        )
        self.InputManager: UserInputManager = get_user_input_manager(
            self.ConnectionManager, self.Player
        )
